...
const ResolutionCharts = () => {
  ...
  const [chartKey, setChartKey] = useState(0); // Force re-mount on screen change

  // Handle window resize - force chart re-mount when switching mobile/desktop
  useEffect(() => {
    ...
    const handleResize = () => {
      ...
      // Force re-mount if switching between mobile/desktop
  ...
  // Render charts when data is available (not dependent on container size or screen width)
  const shouldRenderCharts = !loading && analyticsData;
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '1.5rem' }}>
      ...
      <div style={{
        ...
        {shouldRenderCharts && categoryData && categoryData.length > 0 && (
          <ResponsiveContainer width="100%" height={300} key={`pie-category-${chartKey}`}>
            <PieChart>
              <Pie
                data={categoryData}
                cx="50%"
      ...
      <div style={{
        ...
        {shouldRenderCharts && (
          <ResponsiveContainer width="100%" height={300} key={`line-${chartKey}`}>
            <LineChart data={resolutionTrendData}>
              ...
              <Line 
                ...
                strokeWidth={3}
                strokeOpacity={1}
                dot={{ fill: '#10b981', strokeWidth: 2, stroke: '#10b981', r: 4 }}
      ...
      <div style={{
        ...
        {shouldRenderCharts && (
          <ResponsiveContainer width="100%" height={300} key={`pie-priority-${chartKey}`}>
            <PieChart>
              <Pie
                data={priorityData}
                cx="50%"
      ...
      <div style={{
        ...
        {shouldRenderCharts && (
          <ResponsiveContainer width="100%" height={300} key={`area-${chartKey}`}>
